      ...
      public function depositPayNow(Request $request){
        ...
        try {
            ...
            if ($data->gateway_id == 9){
                ...
                $usd = $data->usd_amo;
                return view('user.deposit.payment_views.authorizepay', compact('track','page_title','usd'));
            }
            ...
            if ($data->gateway_id == 15){
                $gatewayData = $data;
                $page_title = $gatewayData->name;
                return view('user.deposit.payment_views.two_checkout', compact('track','page_title','gatewayData','gateway','data'));
            }
