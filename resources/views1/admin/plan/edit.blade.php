                    ...
                    <form action="{{route('plan-area.update',$workArea->id)}}" method="POST" >
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <select name="capital_back_status" class="form-control">
                                    <option disabled selected value="">@lang('Choose One')</option>
                                    <option {{$workArea->capital_back_status == 0? 'selected' : ''}} value="0">@lang('Capital Back')</option>
                                    <option {{$workArea->capital_back_status == 1? 'selected' : ''}} value="1">@lang('Capital Not Back')</option>
                                </select>
                            </div>
                        </div>
